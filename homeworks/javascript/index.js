...
const tripDuration = prompt(
  'How much time are you planning to spend on the trip?\nWrite the duration in'
);
console.log(
  "You'll need to drive " +
    tripLenght / tripDuration +
    ' kilometers per hour!\nDont forget about the speed limits =)'
);
const sum = prompt(
  'I convert only dollars to hryvnia so\nWrite the amount of $ that you have.'
);
console.log(
  'Its a big amount of ' +
    (sum * 3849) / 100 +
